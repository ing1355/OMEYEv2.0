...
export const SSEResponseMsgTypes: SSEResponseStatusType[] = ['REID_START', 'REID_COMPLETE', 'REID_CANCEL', 'SSE_CONNECTION', 'SSE_DESTROY', 'ADMIN_REID_KILL', 'EXPORT_CANCEL', 'BACKEND_BAD_REQUEST', 'PYTHON_SERVER_ERROR', 'TIME_DURATION_ERROR', 'SUCCESS', 'SERVER_ALIVE']
